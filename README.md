...
```makefile
pkg update -y && pkg upgrade -y && pkg install git python-pip && git clone https://github.com/WilDev26/Check-subdomain.git && cd Check-subdomain && pip install -r requirements.txt
```
